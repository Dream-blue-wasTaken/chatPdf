...
This version uses local embeddings instead of requiring OpenAI API key.
"""
import os
import logging
...
class TogetherChatPDFLocal:
    """A class for handling PDF ingestion and question answering using RAG with Together API and local embeddings."""
    ...
    def __init__(
        ...
        """
        Initialize the TogetherChatPDFLocal instance with API credentials.
    ...
    def ingest(self, pdf_file_path: str):
        ...
        self.vector_store = Chroma.from_documents(
            ...
            persist_directory="chroma_db_together_local",  # Use a different directory
        )
