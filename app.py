...
st.set_page_config(page_title="ChatPDF: Local RAG with DeepSeek")
...
def process_input() -> None:
    """Process user input and generate an assistant response."""
    raw_input = st.session_state.get("user_input", "")
...
def read_and_save_file() -> None:
    """Handle file upload, temporary storage, and ingestion."""
...
def page() -> None:
    ...
    st.header("ChatPDF — Local DeepSeek RAG")
